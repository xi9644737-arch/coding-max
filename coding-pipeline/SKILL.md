...
> **触发**: "帮我搭测试" / "配一下CI" / "加覆盖率" / "这个项目没有测试" / "搭个流水线"
>
...
1. 不写业务测试 2. Phase1不装依赖 3. Phase2才装 4. 不装全局CLI 5. CI跑通再提交 6. 增量覆盖率不卡全局% 7. 已有不重复 8. 已有CI不覆盖 9. Python/Node/Go/Rust/Java一等 10. 审计用文件工具不用终端 11. Monorepo子包独立 12. CI含缓存+覆盖率step
